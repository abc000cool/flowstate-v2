"""Analyse the US-101 penetration sweep (scripts/us101_penetration_sweep.py).
...
``artifacts/us101_penetration_summary.json``.
"""
...
def main() -> None:
    ...
    (REPO / "artifacts" / "us101_penetration_summary.json").write_text(
