...
| **I-24 MOTION flagship** (3.4 miles, ramps, 17,652-episode calibration on the same day) | **3 PASS / 3 FAIL per arm** after FHWA-style capacity and demand calibration (ring emergence, dampening and replicate rows pass; link-flow GEH, speed RMSPE and wave speed fail in all three demand arms). Capacity calibration moved RMSPE 36.8% → 33.7%, throughput 5,266 → 5,710 veh/h, and the fronts to 10.4 km/h standard / 14.2 km/h stripe (in band with the stripe detector) against 14.2 / 16.0 observed; the residual is a standing queue at the Old Hickory merge. Before calibration: 1 PASS / 5 FAIL ([I24_VALIDATION.md](docs/I24_VALIDATION.md), [I24_CAPACITY.md](docs/I24_CAPACITY.md)). |
