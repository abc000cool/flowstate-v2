...
from controllers import default_params, pi_meanfrac
...
def _naive_pi(
    ...
    p = {**default_params("pi_meanfrac"), **params}
    u = max(obs.v_ref, 0.0)
    v_target = p["alpha"] * u
...
class TestAntiWindup:
    ...
    def test_integrator_bounded_in_saturation_and_no_overshoot_on_release(self):
        ...
        v_target = default_params("pi_meanfrac")["alpha"] * v_ref  # 7.5
        ...
        for _ in range(n_sat):
            ...
            cmd_aw, mem_aw = pi_meanfrac(obs, {}, mem_aw)
        ...
        cmd_aw, _ = pi_meanfrac(obs, {}, mem_aw)
    ...
    def test_no_windup_at_lower_saturation(self):
        ...
        mem: Memory = {}
        for _ in range(50):
            _, mem = pi_meanfrac(_obs(v=50.0, v_ref=10.0, dt=0.5), {}, mem)
        obs = _obs(v=7.5, v_ref=10.0, dt=0.5)
        cmd, _ = pi_meanfrac(obs, {}, mem)
