...
## Embeddable simulation (`embed/`)

[embed/README.md](../embed/README.md) — a static, backend-free web page that
replays 45 real SUMO + IDM ring runs (18/22/26 vehicles × 0/1/2 controlled ×
switch-on time × 3 seeds) and the observed I-24 day, built to be iframed
into the public website. Deploy with the root `render.yaml` (Render static
site) or `embed/fly.toml` (Fly.io). Data pack regenerated by
`scripts/website_sim_pack.py`; the brief for the site itself is
[WEBSITE_BRIEF.md](WEBSITE_BRIEF.md).
